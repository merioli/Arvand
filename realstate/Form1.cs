    ...
    public partial class Form1 : Form
    {
        ...
        public class CustomDetailListViewDataCellElement : DetailListViewDataCellElement
        {
            ...
            public override void Synchronize()
            {
                ...
                string owner = rowView.Row["ID"].ToString();
                string melkkind = "";
                ...
                obj.setTitle(serverid, date, owner, melkkind, Dealkind, totalrahn, metriejare, Rtabaghe, khab, zirbana, mycheckbox);
                        ...
                        else
                        {
                            try
                            {
                                ...
                                using (WebClient client = new WebClient())
                                {
                                   ...
                                   // collection.Add("nama", lisenerdetaillist[port].queryModel.nama);
                                    ...
                                    collection.Add("shamsi_from", lisenerdetaillist[port].queryModel.date_from);
                                    collection.Add("shamsi_to", lisenerdetaillist[port].queryModel.date_to);
        ...
        //        };
        //        model.apartment = (apartment.SelectedIndex != -1 || apartment.SelectedIndex.ToString() == "0") ? "" : apartment.SelectedIndex.ToString();
        //        model.garmayesh_sarmayesh = garmayesh_sarmayesh.SelectedIndex.ToString() == "0" ? "" : apartment.SelectedIndex.ToString();
        //        model.kaf_type = (kaf_type.SelectedIndex != -1 || kaf_type.SelectedIndex.ToString() == "0") ? "" : kaf_type.SelectedIndex.ToString();
               
        //        model.address = address.Text;
        //        model.anbari = anbari.Checked ? "1" : "";
        //        model.asansor = asansor.Checked ? "1" : "";
        //        model.ashpazkhane = ashpazkhane.Text;
        ...
        //        model.maghaze = maghaze.Checked ? "1" : "";
        //       // model.mantaghe_id = (mantaghe_id.SelectedIndex != -1 || mantaghe_id.SelectedIndex.ToString() == "0") ? "" : mantaghe_id.SelectedIndex.ToString();
        //        model.mantaghe_id = mantaghe_id.SelectedIndex.ToString();
        //        if (model.mantaghe_name == "0")
        //        {
        //            model.mantaghe_id = "";
        //        }
        //        model.mantaghe_name = mantaghe_name.SelectedIndex.ToString();
        //        if (model.mantaghe_name == "0")
        //        {
        //            model.mantaghe_name = "";
        //        }
        //        model.masahat_zamin = masahat_zamin.Text;
        //        model.mostaghellat = (mostaghellat.SelectedIndex != -1 || mostaghellat.SelectedIndex.ToString() == "0") ? "" : mostaghellat.SelectedIndex.ToString();
        //        model.office = (office.SelectedIndex != -1 || office.SelectedIndex.ToString() == "0") ? "" : office.SelectedIndex.ToString();
        //        model.samt = (samt.SelectedIndex != -1 || samt.SelectedIndex.ToString() == "0") ? "" : samt.SelectedIndex.ToString();
        //        model.sell2khareji = sell2khareji.Checked ? "1" : "";
        //        model.senn = (senn.SelectedIndex != -1 || senn.SelectedIndex.ToString() == "0") ? "" : senn.SelectedIndex.ToString();
        //        model.seraydar = (seraydar.SelectedIndex != -1 || seraydar.SelectedIndex.ToString() == "0") ? "" : seraydar.SelectedIndex.ToString();
        //        model.suit = suit.Checked ? "1" : "";
        //        model.takhlie = takhlie.Checked ? "1" : "";
        ...
        //        model.villa = (villa.SelectedIndex != -1 || villa.SelectedIndex.ToString() == "0") ? "" : villa.SelectedIndex.ToString();
        ...
        void RefreshListhWithNewData(ListOfAdds.RootObject log)
        {
            ...
            try
            {
                ...
                if (log.result.data != null)
                {
                    ...
                    radListView1.DataSource = ConvertToDataTable(songsDataTableBindingSource);
                    ...
                    //allpageholder.Controls.Clear();
                    //int num = (int)log.result.data_count / 20;
                    //for (int page = num; page > 0; page--)
                    //{


                    //    string name = "mainpanel" + page;
                    //    Telerik.WinControls.UI.RadPanel mainpanel = new Telerik.WinControls.UI.RadPanel();
                    //    mainpanel.Dock = System.Windows.Forms.DockStyle.Left;
                    //    mainpanel.Location = new System.Drawing.Point(0, 0);
                    //    mainpanel.Name = name;
                    //    mainpanel.Size = new System.Drawing.Size(35, 30);
                    //    ((Telerik.WinControls.Primitives.BorderPrimitive)(mainpanel.GetChildAt(0).GetChildAt(1))).Visibility = Telerik.WinControls.ElementVisibility.Collapsed;
                    //    //panel.BackColor = System.Drawing.SystemColors.ScrollBar;
                    //    mainpanel.Padding = new System.Windows.Forms.Padding(2, 2, 2, 2);
                    //    //panel.PanelElement.Shape = new RoundRectShape();
                    //    //panel.PanelElement.PanelFill.GradientStyle = GradientStyles.Solid;


                    //    string name2 = "childpanel" + page;
                    //    Telerik.WinControls.UI.RadPanel childpanel = new Telerik.WinControls.UI.RadPanel();
                    //    childpanel.Dock = System.Windows.Forms.DockStyle.Fill;
                    //    childpanel.Location = new System.Drawing.Point(0, 0);
                    //    childpanel.Name = name2;

                    //    childpanel.PanelElement.Shape = new RoundRectShape();
                    //    childpanel.PanelElement.PanelFill.GradientStyle = GradientStyles.Solid;
                    //    System.Windows.Forms.Label pagenum = new Label();
                    //    if (GlobalVariable.page == page.ToString())
                    //    {
                    //        childpanel.PanelElement.PanelFill.BackColor = System.Drawing.SystemColors.ControlDark;
                    //        pagenum.ForeColor = System.Drawing.Color.White;
                    //    }
                    //    else
                    //    {
                    //        childpanel.PanelElement.PanelFill.BackColor = System.Drawing.SystemColors.Control;
                    //        pagenum.ForeColor = System.Drawing.Color.LightSeaGreen;

                    //    }

                    //    //((Telerik.WinControls.UI.RadPanelElement)(panelinsed.GetChildAt(0))).Shape = new RoundRectShape();
                    //    ((Telerik.WinControls.Primitives.BorderPrimitive)(childpanel.GetChildAt(0).GetChildAt(1))).ForeColor = System.Drawing.Color.Gainsboro;
                    //    ((Telerik.WinControls.Primitives.BorderPrimitive)(childpanel.GetChildAt(0).GetChildAt(1))).Visibility = Telerik.WinControls.ElementVisibility.Visible;




                    //    pagenum.Dock = System.Windows.Forms.DockStyle.Fill;
                    //    pagenum.BackColor = System.Drawing.Color.Transparent;
                    //    pagenum.Font = new Font(fonts.Families[0], 10.0F, System.Drawing.FontStyle.Bold);
                    //    pagenum.Location = new System.Drawing.Point(630, 8);
                    //    pagenum.Name = page.ToString();

                    //    pagenum.TabIndex = 10;
                    //    pagenum.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
                    //    // Port.Text = (8000 + panelForList).ToString();
                    //    pagenum.Text = page.ToString();
                    //    pagenum.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
                    //    pagenum.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
                    //    pagenum.Click += new System.EventHandler(this.PageNum_Click);
                    //    childpanel.Controls.Add(pagenum);
                    //    mainpanel.Controls.Add(childpanel);
                    //    allpageholder.Controls.Add(mainpanel);
        ...
        private void refreshPic_Click(object sender, EventArgs e)
        {
            ...
            GlobalVariable.page = "1";
            GlobalVariable.areaaof = "";
            GlobalVariable.catof = "";
        ...
        //    GlobalVariable.page = "1";
        //    GlobalVariable.query = "";
        //    GlobalVariable.mtjfrom = metraj_from.Text;
        //    GlobalVariable.mtjto = metraj_to.Text;
        //    GlobalVariable.rom = room.Text;
        //    GlobalVariable.vadfrom = vadie_from.Text;
        //    GlobalVariable.vadto = vadie_to.Text;
        //    GlobalVariable.ejfrom = ejare_from.Text;
        //    GlobalVariable.ejto = ejare_to.Text;
        //    GlobalVariable.Gtotal_from = total_from.Text;
        //    GlobalVariable.Gtotal_to = total_to.Text;
        //    GlobalVariable.Gtabdil = "0";
        //    if(is_tabdil.Checked == true){
        //        GlobalVariable.Gtabdil = "1";
        //    }
        //    GlobalVariable.Gprice_per_meter_from = per_meter_price_from.Text;
        //    GlobalVariable.Gprice_per_meter_to = per_meter_price_to.Text;

        //    GlobalVariable.Gowner = owner.Text;
        //    GlobalVariable.Gmain_street = main_street.Text;
        //    GlobalVariable.Gsubsidiary_street = subsidiary_street.Text;
        //    GlobalVariable.Galley = alley.Text;
        //    GlobalVariable.Gunit = unit.Text;
        //    GlobalVariable.Gvahed = vahed.Text;
        //    GlobalVariable.Gfloor = floor.Text;
        //    GlobalVariable.Gyear = build_year.Text;
        //    GlobalVariable.Gfacility = "";

        //    if (estakhr.Checked == true){
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "استخر" + ",";
        //    }
        //    if (sona.Checked == true){
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "سونا" + ",";
        //    }
        //    if (jakozi.Checked == true){
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "جکوزی" + ",";
        //    }
        //    if (parking.Checked == true){
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "پارکینگ" + ",";
        //    }
        //    if (motor_khane.Checked == true){
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "موتورخانه" + ",";
        //    }
        //    if (anbari.Checked == true){
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "انبار" + ",";
        //    }
        //    if (balkon.Checked == true){
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "بالکن" + ",";
        //    }
        //    if (Asansor.Checked == true)
        //    {
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "آسانسور" + ",";
        //    } 
        //    if (shofazh.Checked == true)
        //    {
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "شوفاژ" + ",";
        //    } 
        //    if (chiller.Checked == true)
        //    {
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "چیلر" + ",";
        //    } 
        //    if (espilit.Checked == true)
        //    {
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "اسپیلیت" + ",";
        //    }
        //    if (pakage.Checked == true)
        //    {
        //        GlobalVariable.Gfacility = GlobalVariable.Gfacility + "پکیج" + ",";
        //    }

        //    GlobalVariable.Gdirection = "";
        //    if (north.Checked == true)
        //    {
        //        GlobalVariable.Gdirection = GlobalVariable.Gdirection + "شمال" + ",";
        //    }
        //    if (south.Checked == true)
        //    {
        //        GlobalVariable.Gdirection = GlobalVariable.Gdirection + "جنوب" + ",";
        //    }
        //    if (east.Checked == true)
        //    {
        //        GlobalVariable.Gdirection = GlobalVariable.Gdirection + "شرق" + ",";
        //    }
        //    if (west.Checked == true)
        //    {
        //        GlobalVariable.Gdirection = GlobalVariable.Gdirection + "غرب" + ",";
        //    }
        ...
        //                      select p).SingleOrDefault();
        //        GlobalVariable.catof = q.ID;
        //    }

        //    GlobalVariable.Gappname = ap_name.Text;
        //    if (has_pic.Checked == true){
        //        GlobalVariable.has_pic = "1";
        //    }
        //    else
        //    {
        //        GlobalVariable.has_pic = "0";
        ...
        private void radListView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            Form2 form2 = new Form2(selectedindex);
            form2.Show();
        }
        ...
        private void radListView1_Click(object sender, EventArgs e)
        {
            string selectedindex = radListView1.SelectedItem.Value.ToString();
            ListOfAdds.RootObject log = JsonConvert.DeserializeObject<ListOfAdds.RootObject>(GlobalVariable.result);
            var row = log.result.data.Where(x => x.ID == selectedindex).ToList().First();
            if (row.phones != null )
            {
                if (row.phones.Count() > 0)
                {
                    ownerPhone.Text = row.phones.First();
                }
        ...
        private void label56_Click(object sender, EventArgs e)
        {
            ...
            if (listStrLineElements.Count() > 0)
            {
                foreach (var item in listStrLineElements)
                {
                    ...
                    finalstring = finalstring + ADDRESS + "+++";
                }
            }
