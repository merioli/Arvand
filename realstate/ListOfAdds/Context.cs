...
namespace realstate
{
    ...
    public class mehrdadPanel : RadLabelElement
    {
        ...
        public void setTitle(String serverid, String date, String owner, String melkkind, String dealkind, String totalrahn, String metriejare, string tabaghe, string khab, string zirbana, bool mycheckbox)
        {
            label.Text = serverid;
            label2.Text = date;
            label3.Text = owner;
            ...
            label8.Text = tabaghe;
            label9.Text = khab;
            label10.Text = zirbana;
            
            checkbox.Checked = mycheckbox;
            checkbox.Name = serverid;
            //imp.Name = serverid;
